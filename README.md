...
![Design preview for the Weather app coding challenge](../weather-app-main/weather-app-main/preview.jpg)
...
**We strongly recommend overwriting this `README.md` with a custom one.** We've provided a template inside the [`README-template.md`](../weather-app-main/weather-app-main/README-template.md) file in this starter code. The template provides a guide for what to add. A custom `README` will help you explain your project and reflect on your learnings.
